...
type PigDevice struct {
	...
	NetworkFlag      int32  `gorm:"column:network_flag" json:"networkFlag"`           // 联网方式 1:4G-DTU 2:NB-IOT
	InstructFlag     int32  `gorm:"column:instruct_flag" json:"instructFlag"`         // 指令下发方式 1:单条下发 2:多条下发
	SimCode          string `gorm:"column:sim_code" json:"simCode"`                   // SIM卡
	BindStatus       int32  `gorm:"column:bind_status" json:"bindStatus"`             // 绑定状态 0:未绑定 1:已绑定
	LineStatus       int32  `gorm:"column:line_status" json:"lineStatus"`             // 设备状态: 0:离线 1:在线
	...
	GroupId          int64  `gorm:"column:group_id" json:"groupId"`                   // 绑定分组id
